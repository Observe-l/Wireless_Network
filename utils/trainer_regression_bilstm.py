...
FILE_NAME = "tmp_data/"+ options.file + "/loss" + options.loss +  "_re_bilstm_train.txt"
DATA_TMP = "tmp_data/"+ options.file + "/loss" + options.loss +  "_re_bilstm_rec.txt"
...
TIME_OUT = 3
MODEL_NAME = options.file + "_loss" + options.loss +  "_regression_bilstm_window" + str(options.window)
