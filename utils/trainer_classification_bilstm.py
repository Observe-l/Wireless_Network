...
FILE_NAME = "tmp_data/"+ options.file + "/loss" + options.loss +  "_cl_bilstm_train.txt"
DATA_TMP = "tmp_data/"+ options.file + "/loss" + options.loss +  "_cl_bilstm_rec.txt"
...
TIME_OUT = 3
MODEL_NAME = "loss" + options.loss +  "_classification_bilstm"
REMAIN_NUM = 35
