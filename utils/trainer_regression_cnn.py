...
FILE_NAME = "tmp_data/"+ options.file + "/loss" + options.loss +  "_re_cnn_train.txt"
DATA_TMP = "tmp_data/"+ options.file + "/loss" + options.loss +  "_re_cnn_rec.txt"
...
def model_eva():
    ...
    label_pre = model.predict(testdata)[:,-1]
